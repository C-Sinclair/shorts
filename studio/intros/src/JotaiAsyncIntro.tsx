...
export function JotaiAsyncIntro() {
  const frame = useCurrentFrame();

  const opacity = interpolate(frame, [6, 9, 123, 127], [0, 1, 1, 0], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
  });
  const japanOpacity = interpolate(frame, [25, 29, 113, 117], [0, 1, 1, 0], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
  });
  return (
    <main id="jotai-async">
      ...
      <h1
        className="async"
        style={{ color: "white", opacity, paddingTop: 150, paddingLeft: 10 }}
      >
        Async
      </h1>
      <h1
...
const JotaiTitle = () => {
  ...
  const opacity = interpolate(frame, [30, 36], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
  });
  const scale = interpolate(frame, [130, 140, 150], [1, 20, 40], {
    extrapolateLeft: "clamp",
  });
  const translateX = interpolate(frame, [130, 140, 150], [0, 100, 120], {
    extrapolateLeft: "clamp",
  });
  const translateY = interpolate(frame, [130, 140, 150], [0, -25, -50], {
    extrapolateLeft: "clamp",
  });
  return (
    <svg
...
const jotai = staticFile("jotai.png");

const JotaiCharacter = () => {
  const frame = useCurrentFrame();

  const left = interpolate(frame, [70, 90, 130], [200, 200, 2000], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
  });
